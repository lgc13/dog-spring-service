...
class DogControllerTest {
    ...
    class getDogById {
        ...
        public void whenDogIsFoundByIdProvided_returnsDog() throws Exception {
            ...
            mockMvc.perform(get("/dog/1")).andExpect(content().string(objectMapper.writeValueAsString(dog)));
        }
    }
    ...
    class getAllDogs {
        ...
        public void getAllDogs_whenDogsFound_returnsListOfDogs() throws Exception {
            ...
            mockMvc.perform(get("/dog/all")).andExpect(content().string(objectMapper.writeValueAsString(dogList)));
        }
    }
}
